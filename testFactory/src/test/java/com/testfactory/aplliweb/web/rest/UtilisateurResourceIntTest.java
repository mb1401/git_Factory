...
import com.testfactory.aplliweb.repository.UtilisateurRepository;
import com.testfactory.aplliweb.service.UtilisateurService;
import com.testfactory.aplliweb.service.dto.UtilisateurDTO;
import com.testfactory.aplliweb.service.mapper.UtilisateurMapper;
...
public class UtilisateurResourceIntTest {
    ...
    public void createUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getRue()).isEqualTo(DEFAULT_RUE);
    ...
    public void updateUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getRue()).isEqualTo(UPDATED_RUE);
