...
@Injectable()
export class FormateurAngularSPopupService {
            ...
            if (id) {
                this.formateurService.find(id)
                    .subscribe((formateurResponse: HttpResponse<FormateurAngularS>) => {
                        const formateur: FormateurAngularS = formateurResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.formateurModalRef(component, new FormateurAngularS());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    formateurModalRef(component: Component, formateur: FormateurAngularS): NgbModalRef {
