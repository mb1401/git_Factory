...
public class Technicien implements Serializable {
    ...
    public Technicien numeroRue(String numeroRue) {
    ...
    public Technicien pays(String pays) {
        this.pays = pays;
        return this;
    }
    ...
    public Technicien mail(String mail) {
        this.mail = mail;
        return this;
    }
    ...
    public Technicien numeroTel(String numeroTel) {
    ...
    public Technicien username(String username) {
    ...
    public Technicien password(String password) {
    ...
    public Technicien enable(Boolean enable) {
        this.enable = enable;
        return this;
    }
