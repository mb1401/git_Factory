...
import { GestionnaireAngularSDialogComponent } from '../../../../../../main/webapp/app/entities/gestionnaire-angular-s/gestionnaire-angular-s-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('GestionnaireAngularS Management Dialog Component', () => {
        let comp: GestionnaireAngularSDialogComponent;
        let fixture: ComponentFixture<GestionnaireAngularSDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [GestionnaireAngularSDialogComponent],
                providers: [
                    GestionnaireAngularSService
                ]
            })
            .overrideTemplate(GestionnaireAngularSDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(GestionnaireAngularSDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new GestionnaireAngularS(123);
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new GestionnaireAngularS();
